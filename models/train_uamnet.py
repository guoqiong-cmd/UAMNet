...
from models.uamnet import build_uamnet, mu_mse_loss, nll_loss, reg_mae
...
def compile_model(model, steps_per_epoch, epochs, use_nll):
    if use_nll:
        ...
        lr = 5e-4
        # The regression head outputs [mu, log_var]. During warm-up only
        # the mean prediction is supervised, matching the final notebook
        # and the manuscript protocol.
        reg_loss = mu_mse_loss
